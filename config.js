...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || '「Ø₮Ⱡ」ØɄ₮Ⱡ₳₩Ƶ',
    ...
    BOT_INFO: process.env.BOT_INFO || '「Ø₮Ⱡ」ØɄ₮Ⱡ₳₩Ƶ;「Ø₮Ⱡ」Legend;27624751341;https://telegra.ph/file/9e786bdd2538b87c995c8.jpg',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '「Ø₮Ⱡ」ØɄ₮Ⱡ₳₩Ƶ;「Ø₮Ⱡ」Legend;https://telegra.ph/file/9e786bdd2538b87c995c8.jpg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? '「Ø₮Ⱡ」ØɄ₮Ⱡ₳₩Ƶ;「Ø₮Ⱡ」Legend' : process.env.STICKER_DATA,
